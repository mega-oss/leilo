...
# -*- coding: utf-8 -*-
"""
SUPABASE CLIENT - VERSÃO UNIFICADA
✅ Heartbeat com sistema de logs estruturados
...
class SupabaseClient:
    ...
    def heartbeat_start(self, metadata: Optional[Dict] = None) -> bool:
        """
        ✅ Inicia heartbeat com logs estruturados
        ✅ Envia como array [payload] e usa on_conflict=service_name
        """
    ...
    def heartbeat_update(self, status: str = 'active', custom_logs: Optional[Dict] = None, error_message: Optional[str] = None) -> bool:
        """
        ✅ Atualiza heartbeat com logs estruturados
        ✅ Usa PATCH com filtro id=eq.X + on_conflict
        """
    ...
    def heartbeat_success(self, final_stats: Optional[Dict] = None) -> bool:
        ...
        ✅ Permite monitorar que rodou com sucesso
        """
        if not self.heartbeat_enabled or not self.heartbeat_id:
            return False
